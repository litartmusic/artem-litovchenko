...
const PORTFOLIO_ITEMS = [
  ...
  },
  {
    ...
    type: "Film",
    description: 'For "Call of the Silent Cell", directed by boredomresearch, Artem Litovchenko composed and recorded an original 10-minute soundtrack. The project was a deep exploration of sound, silence, and tension, where music becomes part of the narrative itself. Artem handled the full audio process — from editing and comping to dynamic shaping, premixing, and final stem delivery.',
  ...
  },
  {
    ...
    type: "Film",
    description: 'For "All the Light We Cannot See", directed by Seyhmus Altun, Artem Litovchenko composed and recorded an original 5-minute soundtrack. Translating emotion into music, he shaped the atmosphere and brought the story to life through sound — handling everything from recording and editing to dynamic shaping, premixing, and final stem delivery.',
...
const CELLO_ITEMS = [
  {
    ...
    artist: "Sid Acharya",
    youtubeId: "FWTGijqVwiA",
  },
  {
    title: "Ether",
    artist: "Jakob Ahlbom",
    youtubeId: "w5jkFJndLWY",
  },
  {
    title: "Painter",
    artist: "Aimee Carty",
    youtubeId: "3WleQRVGgCk",
  },
  {
    title: "Зима",
    artist: "анастимоза, Третя Штурмова",
    youtubeId: "Y8QMk62WuK0",
  },
  {
    title: "Oh Willow Waly",
    artist: "Karliene",
    youtubeId: "SmL8BfSwL3A",
  },
];
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "0 1.5rem" }}>
          ...
          >
            ...
            <a href="#contact" style={{
              padding: "0.75rem 2rem", background: "transparent", border: "1px solid rgba(232,228,220,0.3)",
        ...
        <FadeIn delay={0.2}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: "4rem" }}>
            <img
              ...
              style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center top", filter: "grayscale(15%)", display: "block" }}
            />
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <p style={{ color: "var(--muted)", lineHeight: 1.9, fontSize: "0.95rem" }}>
                  His work spans cinematic film scoring, immersive game soundtracks, and remote cello recording sessions for composers and artists around the globe.
                </p>
              </div>
            </div>
          </div>
...
{/* PORTFOLIO */}
      <section id="portfolio" style={{ padding: "6rem 0", background: "var(--surface)" }}>
        ...
        {/* Horizontal scroll */}
        <div style={{
          display: "flex", gap: "1.5rem", overflowX: "auto", padding: "0 2rem 2rem",
        ...
        >
          {PORTFOLIO_ITEMS.map((item, i) => (
            <div
              ...
              style={{
                flexShrink: 0, width: "280px", cursor: "pointer", position: "relative", overflow: "hidden",
                border: "1px solid rgba(201,169,110,0.15)", transition: "border-color 0.3s, transform 0.3s",
              }}
              onMouseEnter={e => {
...
{/* VIDEO POPUP */}
      {activeVideo && (() => {
        ...
        return (
          ...
          >
            <div
              style={{ width: "100%", maxWidth: "900px", background: "var(--surface)", border: "1px solid rgba(201,169,110,0.2)" }}
            ...
            >
              ...
              <div style={{ padding: "1.5rem 2rem 2rem" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: "0.5rem" }}>
                  ...
                  <button
                    onClick={() => setActiveVideo(null)}
                    style={{ background: "none", border: "none", color: "var(--muted)", cursor: "pointer", fontSize: "1.5rem", lineHeight: 1, padding: "0 0.5rem" }}
                  >
                    ×
                  </button>
                </div>
      ...
      <section style={{ padding: "6rem 0", background: "var(--bg)" }}>
        ...
        >
          {CELLO_ITEMS.map((item, i) => (
            <div
              key={i}
              onClick={() => setActiveVideo(`yt|${item.youtubeId}|${item.title}|${item.artist}`)}
              style={{
                flexShrink: 0, width: "320px", cursor: "pointer", position: "relative", overflow: "hidden",
                border: "1px solid rgba(201,169,110,0.15)", transition: "border-color 0.3s, transform 0.3s",
              ...
              onMouseEnter={e => {
                (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(201,169,110,0.5)";
                (e.currentTarget as HTMLDivElement).style.transform = "translateY(-6px)";
                const overlay = (e.currentTarget as HTMLDivElement).querySelector(".cello-overlay") as HTMLDivElement;
                if (overlay) overlay.style.opacity = "1";
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(201,169,110,0.15)";
            ...
            >
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                <div className="cello-overlay" style={{
                  position: "absolute", inset: 0, background: "rgba(8,10,15,0.7)",
      ...
      <section id="contact" style={{ padding: "8rem 2rem", maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <a href="mailto:artemlitovchenkomusic@gmail.com" style={{
            ...
            textDecoration: "none", fontSize: "0.8rem", letterSpacing: "0.15em", textTransform: "uppercase",
